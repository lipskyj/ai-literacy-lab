      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 bg-black/60 backdrop-blur-sm overflow-y-auto">
          <motion.div
            ...
            className="max-w-xl w-full bg-white border border-gray-200 rounded-3xl p-6 md:p-10 shadow-2xl relative text-right my-8"
            dir="rtl"
          >
            <button
              onClick={handleClose}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        placeholder="השם שלך..."
                        className="w-full p-3 text-sm rounded-xl border-2 border-gray-200 focus:border-orange-500 focus:outline-none"
                      />
                    </div>
                    <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      placeholder="מה הכלי מלמד? מה התלמידים יגלו?"
                      rows={2}
                      className="w-full resize-none p-3 text-sm rounded-xl border-2 border-gray-200 focus:border-orange-500 focus:outline-none"
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      {imagePreview ? (
                        ...
                        <label className="flex items-center justify-center gap-2 h-20 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-orange-500 transition-colors">
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white text-base font-bold rounded-xl flex items-center justify-center gap-2 hover:from-orange-600 hover:to-orange-700 disabled:opacity-50"
                  >
                    {isSubmitting ? (
                      <>
